...
author=Alex Bertram
lang=en
excerpt=GCC-Bridge is a C/Fortran compiler targeting the Java Virtual Machine (JVM) that makes it possible for Renjin to run R packages that include &lsquo;native&rsquo; C and Fortran code without sacrificing platform independence.
~~~~~~
