...
Congratulations to [Ce Gao](http://gaocegege.com/), who has just released an early version of [Processing.R](https://processing-r.github.io/) that uses Renjin to enables users to write Processing sketches using the R language. The mode can be installed in the Processing Development Environment (PDE).

Check out their GitHub [Repo](https://github.com/gaocegege/Processing.R) as well as Processing.R [tutorials](https://processing-r.github.io/tutorials/)
